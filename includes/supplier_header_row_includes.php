<div class="row" style="height: 200px;">
    ...
    <div class="bg-dark text-white rounded d-flex align-items-center justify-content-between px-4" style="height: 70px;">
        ...
        <div class="d-flex align-items-center gap-3 fs-6">
            ...
            <a href="supplier-dashboard.php" class="text-white text-decoration-none d-flex align-items-center">
            ...
            <a href="#" class="text-white text-decoration-none d-flex align-items-center">
                ...
                <span><?php echo ucwords($supplierrow["supplier_name"]); ?></span>
            </a>


            <a href="../controller/supplier_login_controller.php?status=logout" class="text-white fs-5">
