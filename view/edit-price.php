                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            ...
                            <form action="../controller/price_controller.php?status=update_price" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" id="price" name="price" class="form-control" value="<?php echo $pricerow["price"]; ?>">
                                        </div>
                                        <div class="col-md-6">
