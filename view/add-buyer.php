                        ...
                        <div class="card-body" style="background:linear-gradient(90deg,#FDE9E1 0%,#B9D9EB 100%);">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="company_registration" id="company_registration" class="form-control" >
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="business_type" id="business_type" class="form-select" >
                                        ...
                                        <?php while($businessTypeRow = $businessTypeResult->fetch_assoc()) { ?>
                                            <option value="<?= $businessTypeRow["business_type_id"]; ?>"><?= $businessTypeRow["business_type_name"]; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="url" name="website" id="website" class="form-control" placeholder="https://www.company.com" >
                                </div>

                                <div class="col-12">
                                    <label class="form-label">Address</label>
                                    <input type="text" name="company_address_line_1" id="company_address_line_1" class="form-control mb-2" >
                                    <input type="text" name="company_address_line_2" id="company_address_line_2" class="form-control">
                                </div>
                        ...
                        <div class="card-body" style="background:linear-gradient(90deg,#FDE9E1 0%,#B9D9EB 100%);">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="contact_nic" id="contact_nic" class="form-control" >
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="office_address_line_1" id="office_address_line_1" class="form-control mb-1" >
                                    
                                    <input type="text" name="office_address_line_2" id="office_address_line_2" class="form-control mb-1">
                                    
                                    <input type="text" name="office_address_line_3" id="office_address_line_3" class="form-control mb-1">
                                </div>
