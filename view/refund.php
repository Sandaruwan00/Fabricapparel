...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-8" style="text-align:right;">
                <div class="btn-group" role="group">
                    ...
                    <a href="refund.php" class="btn btn-outline-info active">
                        Refunds
    ...
    <script>
        function processRefund(refund_id, refund_amount) {
            ...
            document.getElementById('process_refund_amount').textContent = 'Rs.' + parseFloat(refund_amount).toLocaleString('en-LK', {
