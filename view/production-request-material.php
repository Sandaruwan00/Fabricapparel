        ...
        <div class="row">
            ...
            <div class="col-md-8" style="text-align:right;">
                <div class="btn-group">
                    ...
                    <a href="production-request-material.php" class="btn btn-outline-secondary active">Request Materials</a>
                ...
                <form action="../controller/production_controller.php?status=production_stock_request" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="psr_qty" min="1" class="form-control" required>
                        </div>
...
<div class="modal fade" id="reportModal">
    <div class="modal-dialog">
        <form action="generate-production-material-request-report.php" method="post" target="_blank">

            <div class="modal-content">

                <div class="modal-header">
                    <h5 class="modal-title">Generate Materials Requests Report</h5>
