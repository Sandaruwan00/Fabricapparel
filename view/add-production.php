...
$ordersInProduction = $productionObj->getAllOrdersInProduction()
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 text-center">
                <h1 style="margin:0; font-size:28px; font-weight:600;">
                    Pending Orders to Start Production
                </h1>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover align-middle" id="inproductiontable">
                        ...
                        <tbody>
                            <?php while ($row = $ordersInProduction->fetch_assoc()) {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#startProductionModal" onclick="loadOrder( '<?php echo $order_id; ?>')">
    ...
    <div class="modal fade" id="startProductionModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="../controller/production_controller.php?status=start_production" method="post">
                    <input type="hidden" name="order_id" value="<?php echo $order_id; ?>">
                    <div class="modal-body py-4">
                        <p class="mt-3 fs-5">Are you sure you want to start the production?</p>
                    </div>
                    <div class="modal-footer justify-content-end">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                            Cancel
                        </button>
                        <button type="submit" id="confirmStartBtn" class="btn btn-success">
