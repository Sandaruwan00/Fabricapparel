        ...
        <div class="row">
            ...
            <div class="col-md-8" style="text-align:right;">
                <div class="btn-group">
                    ...
                    <a href="vehicle.php" class="btn btn-outline-secondary active">Vehicles</a>
                    <a href="generate-vehicle-report.php" class="btn btn-outline-warning">Generate Reports</a>
                </div>
            </div>
        </div>
