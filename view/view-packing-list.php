        ...
        <div class="row">
            ...
            <div class="col-md-8" style="text-align:right;">
                <div class="btn-group">
                    ...
                    <a href="view-packing-list.php" class="btn btn-outline-success active">View Packings</a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover align-middle" id="packingtable">
                        <thead class="table-secondary">
                            <tr class="text-center">
                                <th width="12%">Packing ID</th>
                                <th width="10%">Order ID</th>
                                <th width="35%">Company</th>
                                <th width="15%">Due Date</th>
                                <th width="15%">Packing Status</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center <?= $color; ?>"><?php echo $row["packing_status"]; ?></td>

                                    <td>
                                        <a href="../view/view-packing.php?packing_id=<?php echo $row["packing_id"]; ?>" class="btn btn-info btn-sm">
                                            <i class="bi bi-eye-fill"></i> View Packing
                                        </a>
