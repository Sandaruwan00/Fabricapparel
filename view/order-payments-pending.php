...
$orderObj = new Order();
$orderPaymentResult = $orderObj->getPendingOrderPayments();
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-4 text-center">
                <h1 style="font-size:28px; font-weight:600;">Pending Payments</h1>
            </div>
        </div>
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="order-payments-pending.php">Pending Payments <span class="badge text-bg-warning"><?php echo $badge["pending_count"];  ?></span></a>
            </li>
...
<div class="modal fade" id="reportModal">
    <div class="modal-dialog">
        <form action="generate-order-payments-report.php" method="post" target="_blank">
