...
$orderObj = new Order();
$orderPaymentResult = $orderObj->getRejectedOrderPayments();
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <h1 style="font-size:28px; font-weight:600;">Rejected Payments</h1>
            </div>
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="order-payments-rejected.php">Rejected Payments</a>
            </li>
        </ul>
